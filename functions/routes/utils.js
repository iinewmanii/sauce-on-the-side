module.exports = {
  auth: (req, res, next) => {
    ...
    if (!user) {
      res.redirect('/login?fromUrl=' + req.path);
    } else {
      next();
    }
  },
  getTagList: () => {
    const tagList = [
      'Anger', 'Bad Idea', 'Bar', 'Bartender', 'BOH', 'Breaking News', 'Busy', 'Claim', 'Complaint',
      'Confused', 'Customer', 'Date', 'Day Off', 'Debate', 'Drunk', 'Equipment', 'Fire', 'FOH',
      'Hazing', 'Health Inspector', 'Holiday', 'Kitchen', 'Manager', 'Morale', 'New Hire', 'Owner',
      'Police', 'Ranch', 'Restaurant Review', 'Server', 'Suburban', 'Tip', 'Understaffed', 'Walk-In',
    ];
    return tagList;
  },
  getBannedWordsList: () => {
    const bannedList = ['4r5e', '5h1t', '5hit', 'a55', 'anal', 'anus', 'ar5e', 'arrse', 'arse',
      ...
      'butthole', 'buttmuch', 'buttplug', 'c0ck', 'c0cksucker', 'carpet muncher', 'cawk', 'chink',
      ...
      'dick', 'dickhead', 'dildo', 'dildos', 'dink', 'dinks', 'dirsa', 'dlck', 'dog-fucker',
      'doggin', 'dogging', 'donkeyribber', 'doosh', 'duche', 'dyke', 'ejaculate', 'ejaculated',
      'ejaculates', 'ejaculating', 'ejaculatings', 'ejaculation', 'ejakulate', 'f u c k',
      'f u c k e r', 'f4nny', 'fag', 'fagging', 'faggitt', 'faggot', 'faggs', 'fagot', 'fagots',
      ...
      'fukwit', 'fux', 'fux0r', 'f_u_c_k', 'gangbang', 'gangbanged', 'gangbangs', 'gaylord',
      'gaysex', 'goatse', 'God', 'god-dam', 'god-damned', 'goddamn', 'goddamned', 'hardcoresex',
      ...
      'niggaz', 'nigger', 'niggers', 'nob', 'nob jokey', 'nobhead', 'nobjocky', 'nobjokey',
      ...
      'phukking', 'phuks', 'phuq', 'pigfucker', 'pimpis', 'piss', 'pissed', 'pisser', 'pissers',
      ...
      'rectum', 'retard', 'rimjaw', 'rimming', 's hit', 's.o.b.', 'sadist', 'schlong', 'screwing',
      'scroat', 'scrote', 'scrotum', 'semen', 'sex', 'sh!+', 'sh!t', 'sh1t', 'shag', 'shagger',
      'shaggin', 'shagging', 'shemale', 'shi+', 'shit', 'shitdick', 'shite', 'shited', 'shitey',
      'shitfuck', 'shitfull', 'shithead', 'shiting', 'shitings', 'shits', 'shitted', 'shitter',
